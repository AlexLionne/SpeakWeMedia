...
async function run() {
    ...
    if (faceDetection) {
        ...
        await faceapi.loadFaceLandmarkModel('/resources/face-detector-models')
        await faceapi.loadFaceRecognitionModel('/resources/face-detector-models')
        await faceapi.loadFaceLandmarkTinyModel('/resources/face-detector-models')
    }
